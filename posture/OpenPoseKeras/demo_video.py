...
class VideoProcessorSK(VideoProcessor):
    ...
    def close(self):
        getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and getattr(self, "svid", None) and self.svid.close()
        getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and getattr(self, "vid", None) and self.vid.close()
